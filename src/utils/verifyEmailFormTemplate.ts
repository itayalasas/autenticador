// Template for VerifyEmailForm - deployed as part of the Netlify auth project

export const VERIFY_EMAIL_FORM_TEMPLATE = `import React, { useEffect, useState } from 'react';
