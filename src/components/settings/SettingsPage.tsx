...
import { User, Crown, CreditCard, Shield, Bell, Globe, Save, Check, Star, ArrowRight, AlertTriangle, Lock, Key, Smartphone, Mail, Clock, Trash2, Filter, CheckCircle, Info, AlertCircle, X, Eye, EyeOff } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const handleUpdateNotificationPreferences = (newPreferences: any) => {
    setProfileData(prev => ({
      ...prev,
  ...
  const handleConfirmAction = (title: string, message: string, onConfirm: () => void) => {
    showConfirmation(title, message, onConfirm, { type: 'warning', confirmText: 'Confirmar' });
  };

  const renderNotificationsTab = () => (
    <NotificationsSettings
      preferences={profileData.notifications}
