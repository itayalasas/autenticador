/*
  ...
  2. Seguridad
    ...
    - Políticas simplificadas para service_role y authenticated
...
CREATE POLICY "rate_limits_all_access" ON rate_limits FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "failed_attempts_all_access" ON failed_login_attempts FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "security_alerts_select" ON security_alerts FOR SELECT TO authenticated USING (true);
CREATE POLICY "security_alerts_insert" ON security_alerts FOR INSERT TO service_role WITH CHECK (true);
CREATE POLICY "security_alerts_update" ON security_alerts FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
