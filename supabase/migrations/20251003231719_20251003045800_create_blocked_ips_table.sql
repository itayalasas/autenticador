/*
  ...
  1. Nueva Tabla
    - `blocked_ips`
      ...
      - `log_id` (uuid, nullable, foreign key) - Log que originó el bloqueo
...
CREATE TABLE IF NOT EXISTS blocked_ips (
  ...
  log_id uuid REFERENCES auth_logs(id) ON DELETE SET NULL,
...
-- Política: Usuarios autenticados pueden insertar bloqueos
