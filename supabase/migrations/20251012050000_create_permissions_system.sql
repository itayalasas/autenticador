/*
  ...
  1. Nuevas Tablas
    - `application_menus`: Menús/recursos de cada aplicación
      ...
      - `name` (text) - Nombre del menú/recurso
      - `slug` (text) - Identificador único del menú
      - `description` (text) - Descripción del menú
      - `icon` (text) - Icono del menú
    ...
    - `menu_actions`: Acciones disponibles por menú
      ...
      - `name` (text) - Nombre de la acción (Crear, Leer, Actualizar, Eliminar, etc.)
      - `slug` (text) - Identificador único (create, read, update, delete, etc.)
    ...
    - `role_permissions`: Permisos asignados a cada rol
      ...
      - `granted` (boolean) - Si tiene el permiso
      - `created_at` (timestamp)
      - `updated_at` (timestamp)
