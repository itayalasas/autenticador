# Edge Function: collect-source-files

## 📝 Código Completo

Este es el código actualizado de la Edge Function que lee los archivos corregidos.
...
2. Si no existe, créalo con el código de arriba
...
Después de desplegar, verifica que la función esté activa:
...
Deberías ver:
```
collect-source-files    deployed    2025-10-11
```
...
Después de desplegar esta función, haz un nuevo deploy desde tu dashboard de AuthSystem. La función ahora leerá los archivos corregidos sin `useMemo`/`useCallback` y el error React #310 desaparecerá.
